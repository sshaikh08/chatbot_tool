...
OPTIMIZE_SOL_PROMPT_PATH = Path.joinpath(CURRENT_FILE_DIRECTORY, 'chat_bot/prompts/optimize_solution_prompt.txt')
OPTIMIZE_SOL_PROMPT_PATH_2 = Path.joinpath(TEXT_FILES_PATH, 'chat_bot/prompts/optimize_solution_prompt.txt')
...
if __name__ == '__main__':
    ...
    print(f"CURRENT FILE: {CURRENT_FILE}\n"
          ...
          f"Prompt Path 2: {OPTIMIZE_SOL_PROMPT_PATH_2}\n"
