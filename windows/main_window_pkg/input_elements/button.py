...
if __name__ == '__main__':
    ...
    test_text = text_input.create_solution_txt(test_window)
    test_text.pack()
...
# # get_button_1.pack()
#
    get_button_2 = create_get_solution_button(test_window,BORDER_WIDTH, GET_SOLUTION_TEXT, lambda: gettext(test_text))
    get_button_2.pack()
